# Thriller Streaming Recommender — Streamlit (with Language Filter)
...
@st.cache_data(ttl=3600)
def discover_movies(page: int, min_votes: int, language: str) -> Dict:
    params = {
    ...
    if language != "All":
        params["with_original_language"] = "hi" if language == "Hindi" else "en"
...
language_filter = st.sidebar.radio("Select Language", ["All", "Hindi", "English"], index=0)
